...
private:
	...
	void Init()
	{
		...
		this->h_mass_dressed = new TH1D("h_mass_dressed_"+Type, "", nBin, 10, 3010 );
		this->vec_Hist.push_back( this->h_mass_dressed );

		this->h_mass_postFSR = new TH1D("h_mass_postFSR_"+Type, "", nBin, 10, 3010 );
		...
		this->h2D_dressed_reco = new TH2D("h2D_dressed_reco_"+Type, "", nBin, 10, 3010, nBin, 10, 3010 );
		this->vec_2DHist.push_back( this->h2D_dressed_reco );

		this->h2D_postFSR_reco = new TH2D("h2D_postFSR_reco_"+Type, "", nBin, 10, 3010, nBin, 10, 3010 );
