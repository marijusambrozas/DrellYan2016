...
enum SelProc_t
{
    ...
    _EMu_QCDMuEnriched_15to20, _EMu_QCDMuEnriched_20to30, _EMu_QCDMuEnriched_30to50, _EMu_QCDMuEnriched_50to80, _EMu_QCDMuEnriched_80to120,
    _EMu_QCDMuEnriched_120to170, _EMu_QCDMuEnriched_170to300, _EMu_QCDMuEnriched_300to470, _EMu_QCDMuEnriched_470to600, _EMu_QCDMuEnriched_600to800,
    _EMu_QCDMuEnriched_800to1000, _EMu_QCDMuEnriched_1000toInf,
    _EndOf_EMu_QCDMuEnriched_Normal,
    _EMu_QCDEMEnriched_20to30, _EMu_QCDEMEnriched_30to50, _EMu_QCDEMEnriched_50to80, _EMu_QCDEMEnriched_80to120, _EMu_QCDEMEnriched_120to170,
    _EMu_QCDEMEnriched_170to300, _EMu_QCDEMEnriched_300toInf,
    _EndOf_EMu_QCDEMEnriched_Normal,
    ...
    _EMu_DYTauTau_Full, _EMu_ttbar_Full, _EMu_VVnST, _EMu_QCDMuEnriched_Full, _EMu_QCDEMEnriched_Full, _EMu_Bkg_Full,
...
SelProc_t next ( SelProc_t pr )    // Processes that begin with "EndOf" will be skipped by this
{
  if ( pr == _EndOf_EMu )
      return pr;
  else if ( pr == _MuMu_QCDMuEnriched_1000toInf || pr == _EE_QCDEMEnriched_300toInf || pr == _EE_SingleElectron_H || pr == _EMu_QCDEMEnriched_300toInf )
      return SelProc_t(int(pr)+3);
            ...
            pr == _EndOf_EE_QCDEMEnriched_Normal || pr == _EE_DoubleEG_H || pr == _EndOf_EE_SingleElectron_Normal ||  pr == _EE_SingleElectron_Full ||
            pr == _Test_EE || pr == _EMu_DYTauTau_50toInf || pr == _EMu_ttbar_1000toInf || pr == _EMu_WW || pr == _EMu_WJets ||
            pr == _EMu_QCDMuEnriched_1000toInf || pr == _EMu_SingleMuon_H || pr == _EMu_SingleMuon_Full )
...
void LocalFileMgr::SetProc ( SelProc_t pr, Bool_t ClearOld )
{
    ...
    if ( pr == _MuMu_DY_10to50 ) // Only MuMu evens are counted in Wsum and nEvents
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7446893+16016651+9815322 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 16628 );
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_v2" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7446893+16016651+9815322 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 35165 );
        else nEvents.push_back( 35162 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M10to50_v2"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation + Location );

        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_ext1v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7446893+16016651+9815322 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 21697 );
    ...
    else if( pr ==_MuMu_DY_50to100 ) // Only MuMu evens are counted in Wsum and nEvents
    {
        ...
        Type = "SIGNAL";
        HistLocation = "/media/sf_DATA/SelectedMuMu/Histos/";
        Tag.push_back( "SelectedMuMu_DYMuMu_M50to100" ); Xsec.push_back( 5705.9044344/3.0 ); Wsum.push_back( 26175605.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 11107684 );
        else nEvents.push_back( 11105651 );
    ...
    else if( pr ==_MuMu_DY_100to200 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M100to200" ); Xsec.push_back( 226.6/3.0 ); Wsum.push_back( 233822+3199473 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 124131 );
        else nEvents.push_back( 124141 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M100to200"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedMuMu_DYMuMu_M100to200_ext" ); Xsec.push_back( 226.6/3.0 ); Wsum.push_back( 233822+3199473 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1753575 );
    ...
    else if( pr ==_MuMu_DY_200to400 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M200to400" ); Xsec.push_back( 7.77/3.0 ); Wsum.push_back( 56340.0 );
    ...
    else if( pr ==_MuMu_DY_400to500 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M400to500" ); Xsec.push_back( 0.4065/3.0 ); Wsum.push_back( 50136.0 );
    ...
    else if( pr ==_MuMu_DY_500to700 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M500to700" ); Xsec.push_back( 0.2334/3.0 ); Wsum.push_back( 48188.0 );
    ...
    else if( pr ==_MuMu_DY_700to800 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M700to800" ); Xsec.push_back( 0.03614/3.0 ); Wsum.push_back( 44984.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 60544 );
    ...
    else if( pr ==_MuMu_DY_800to1000 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M800to1000" ); Xsec.push_back( 0.03047/3.0 ); Wsum.push_back( 43496.0 );
    ...
    else if( pr ==_MuMu_DY_1000to1500 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M1000to1500" ); Xsec.push_back( 0.01636/3.0 ); Wsum.push_back( 40110.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 61575 );
    ...
    else if( pr ==_MuMu_DY_1500to2000 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M1500to2000" ); Xsec.push_back( 0.00218/3.0 ); Wsum.push_back( 37176.0 );
    ...
    else if( pr ==_MuMu_DY_2000to3000 )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M2000to3000" ); Xsec.push_back( 0.0005156/3.0 ); Wsum.push_back( 33360.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 64138 );
    ...
    else if ( pr ==_MuMu_DY_Full )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_v1" ); Wsum.push_back( 7446893+16016651+9815322 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 16628 );
        else nEvents.push_back( 16629 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M10to50_v1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation + Location );

        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_v2" ); Wsum.push_back( 7446893+16016651+9815322 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 35165 );
        else nEvents.push_back( 35162 );
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M10to50_ext1v1" ); Wsum.push_back( 7446893+16016651+9815322 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 21697 );
        else nEvents.push_back( 21689 );
...
//        Xsec.push_back( 5869.58346/3.0 );
        Xsec.push_back( 5705.9044344/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 11107684 );
        else nEvents.push_back( 11105661 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M50to100"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedMuMu_DYMuMu_M100to200" ); Wsum.push_back( 233822+3199473 );
//        Xsec.push_back( 226/3.0 );
        Xsec.push_back( 226.6/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 124131 );
        else nEvents.push_back( 124141 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M100to200"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedMuMu_DYMuMu_M100to200_ext" ); Wsum.push_back( 233822+3199473 );
//        Xsec.push_back( 226/3.0 );
        Xsec.push_back( 226.6/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1753575 );
        else nEvents.push_back( 1753461 );
        ...
        Tag.push_back( "SelectedMuMu_DYMuMu_M200to400" ); Wsum.push_back( 56340.0 );
//        Xsec.push_back( 7.67/3.0 );
        Xsec.push_back( 7.77/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 47739 );
        else nEvents.push_back( 47734 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M200to400"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.423/3.0 );
        Xsec.push_back( 0.4065/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 54768 );
        else nEvents.push_back( 54768 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M400to500"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.24/3.0 );
        Xsec.push_back( 0.2334/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 58094 );
        else nEvents.push_back( 58094 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M500to700"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.035/3.0 );
        Xsec.push_back( 0.03614/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 60544 );
        else nEvents.push_back( 60544 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M700to800"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.03/3.0 );
        Xsec.push_back( 0.03047/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 61467 );
        else nEvents.push_back( 61467 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M800to1000"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.016/3.0 );
        Xsec.push_back( 0.01636/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 61575 );
        else nEvents.push_back( 61575 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M1000to1500"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.002/3.0 );
        Xsec.push_back( 0.00218/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 63830 );
        else nEvents.push_back( 63830 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M1500to2000"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
...
//        Xsec.push_back( 0.00054/3.0 );
        Xsec.push_back( 0.0005156/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 64138 );
        else nEvents.push_back( 64138 );
        Location = "SelectedMuMu/MC_signal/SelectedMuMu_DYMuMu_M2000to3000"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    ...
    else if ( pr == _MuMu_DYTauTau_10to50 ) // Only TauTau evens are counted in Wsum and nEvents
    {
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_v2" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_ext1v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 21 );
        else nEvents.push_back( 22 );
    ...
    else if ( pr == _MuMu_DYTauTau_50toInf ) // Only TauTau evens are counted in Wsum and nEvents
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 22951 );
...
//        Xsec->push_back( 6104.0/3.0 );
    ...
    else if ( pr == _MuMu_DYTauTau_Full )
    {
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_v1" ); Wsum.push_back( 7407794+15912921+9759664 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 10 );
        else nEvents.push_back( 10 );
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_v2" ); Wsum.push_back( 7407794+15912921+9759664 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 22 );
        else nEvents.push_back( 22 );
        ...
        Tag.push_back( "SelectedMuMu_DYTauTau_M10to50_ext1v1" ); Wsum.push_back( 7407794+15912921+9759664 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 21 );
        else nEvents.push_back( 22 );
...
//        Xsec->push_back( 6104.0/3.0 );
    ...
    else if ( pr == _MuMu_ttbar )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 355297 );
        else nEvents.push_back( 355225 );
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 359411 );
        else nEvents.push_back( 359359 );
    ...
    else if ( pr == _MuMu_ttbar_700to1000 )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 204881 );
        else nEvents.push_back( 204873 );
    ...
    else if( pr == _MuMu_ttbar_1000toInf )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 111068 );
    ...
    else if ( pr == _MuMu_tW )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 41920 );
    ...
    else if ( pr == _MuMu_tbarW )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 41664 );
        else nEvents.push_back( 41653 );
    ...
    else if ( pr == _MuMu_ZZ )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 24782 );
        else nEvents.push_back( 24775 );
    ...
    else if ( pr == _MuMu_WZ )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 38968 );
        else nEvents.push_back( 38955 );
    ...
    else if ( pr == _MuMu_WW )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 29233 );
    ...
    else if( pr == _MuMu_WJets )
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 20 );
...
//        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    ...
    else if ( pr == _MuMu_SingleMuon_C ) // Number of events in the original sample (before selection) are written into Wsum
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1431094 );
        else nEvents.push_back( 1430889 );
    ...
    else if ( pr == _MuMu_SingleMuon_D ) // Number of events in the original sample (before selection) are written into Wsum
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2385581 );
        else nEvents.push_back( 2385014 );
    ...
    else if ( pr == _MuMu_SingleMuon_E ) // Number of events in the original sample (before selection) are written into Wsum
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2135933 );
        else nEvents.push_back( 2135391 );
    ...
    else if ( pr == _MuMu_SingleMuon_F ) // Number of events in the original sample (before selection) are written into Wsum
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1634339 );
        else nEvents.push_back( 1634022 );
    ...
    else if ( pr == _MuMu_SingleMuon_H ) // Number of events in the original sample (before selection) are written into Wsum
    {
        ...
        if ( ROCCORR == kTRUE ) nEvents.push_back( 127624 );
        else nEvents.push_back( 127619 );
    ...
    else if ( pr == _EE_DY_Full )
    {
        ...
        Tag.push_back( "SelectedEE_DYEE_M10to50_v1" ); Wsum.push_back( 7447023+16016761+9811434 ); nEvents.push_back( 10426 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M10to50_v1.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M10to50_v2" ); Wsum.push_back( 7447023+16016761+9811434 ); nEvents.push_back( 22623 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M10to50_v2.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M10to50_ext1v1" ); Wsum.push_back( 7447023+16016761+9811434 ); nEvents.push_back( 13836 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M10to50_ext1v1.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M50to100" ); Wsum.push_back( 26166194.0 ); nEvents.push_back( 7706926 );
//        Xsec.push_back( 5869.58346/3.0 );
        Xsec.push_back( 5705.9044344 /3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M50to100.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M100to200" ); Wsum.push_back( 234322+3203563 ); nEvents.push_back( 86786 );
//        Xsec.push_back( 226/3.0 );
        Xsec.push_back( 226.6/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M100to200.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M100to200_ext" ); Wsum.push_back( 234322+3203563 ); nEvents.push_back( 1224185 );
//        Xsec.push_back( 226/3.0 );
        Xsec.push_back( 226.6/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M100to200_ext.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M200to400" ); Wsum.push_back( 56144.0 ); nEvents.push_back( 33801 );
//        Xsec.push_back( 7.67/3.0 );
        Xsec.push_back( 7.77/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M200to400.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M400to500" ); Wsum.push_back( 50420.0 ); nEvents.push_back( 40021 );
//        Xsec.push_back( 0.423/3.0 );
        Xsec.push_back( 0.4065/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M400to500.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M500to700" ); Wsum.push_back( 48039.0 ); nEvents.push_back( 42770 );
//        Xsec.push_back( 0.24/3.0 );
        Xsec.push_back( 0.2334 /3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M500to700.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M700to800" ); Wsum.push_back( 46114.0 ); nEvents.push_back( 45351 );
//        Xsec.push_back( 0.035/3.0 );
        Xsec.push_back( 0.03614/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M700to800.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M800to1000" ); Wsum.push_back( 44256.0 ); nEvents.push_back( 46888 );
//        Xsec.push_back( 0.03/3.0 );
        Xsec.push_back( 0.03047 /3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M800to1000.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M1000to1500" ); Wsum.push_back( 39712.0 ); nEvents.push_back( 47223 );
//        Xsec.push_back( 0.016/3.0 );
        Xsec.push_back( 0.01636/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M1000to1500.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M1500to2000" ); Wsum.push_back( 37287.0 ); nEvents.push_back( 50387 );
//        Xsec.push_back( 0.002/3.0 );
        Xsec.push_back( 0.00218/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M1500to2000.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYEE_M2000to3000" ); Wsum.push_back( 34031.0 ); nEvents.push_back( 50986 );
//        Xsec.push_back( 0.00054/3.0 );
        Xsec.push_back( 0.0005156/3.0 );
        Location = "SelectedEE/MC_signal/SelectedEE_DYEE_M2000to3000.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    ...
    else if ( pr == _EE_DYTauTau_10to50 ) // Only TauTau evens are counted in Wsum and nEvents
    {
        ...
        Tag.push_back( "SelectedEE_DYTauTau_M10to50_v1" ); Wsum.push_back( 7407794+15912921+9759664 ); nEvents.push_back( 7 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        Location = "SelectedEE/MC_bkg/SelectedEE_DYTauTau_M10to50_v1.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYTauTau_M10to50_v2" ); Wsum.push_back( 7407794+15912921+9759664 ); nEvents.push_back( 26 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
        Location = "SelectedEE/MC_bkg/SelectedEE_DYTauTau_M10to50_v2.root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEE_DYTauTau_M10to50_ext1v1" ); Wsum.push_back( 7407794+15912921+9759664 ); nEvents.push_back( 17 );
//        Xsec.push_back( 18610.0/3.0 );
        Xsec.push_back( 18810.0/3.0 );
...
//        Xsec.push_back( 18610.0/3.0 );
    ...
    else if ( pr == _EMu_DYTauTau_10to50 ) // Only TauTau evens are counted in Wsum and nEvents
    {
        ...
        Tag.push_back( "SelectedEMu_DYTauTau_M10to50_v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
        ...
        Tag.push_back( "SelectedEMu_DYTauTau_M10to50_v2" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
        ...
        Tag.push_back( "SelectedEMu_DYTauTau_M10to50_ext1v1" ); Xsec.push_back( 18810.0/3.0 ); Wsum.push_back( 7407794+15912921+9759664 );
...
//        Xsec->push_back( 6104.0/3.0 );
    ...
    else if( pr == _EMu_QCDMuEnriched_15to20 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt15to20" ); Xsec.push_back( 720648000*0.00042 ); Wsum.push_back( 4141251.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt15to20"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_20to30 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt20to30" ); Xsec.push_back( 1273190000*0.003 ); Wsum.push_back( 31302080.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt20to30"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_30to50 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt30to50" ); Xsec.push_back( 139803000*0.01182 ); Wsum.push_back( 29717171.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt30to50"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_50to80 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt50to80" ); Xsec.push_back( 19222500*0.02276 ); Wsum.push_back( 19806914.0 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt50to80"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_80to120 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt80to120" ); Xsec.push_back( 2758420*0.03844 ); Wsum.push_back( 13555323+9797243 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt80to120"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt80to120_ext1" ); Xsec.push_back( 2758420*0.03844  ); Wsum.push_back( 13555323+9797243 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt80to120_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_120to170 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt120to170" ); Xsec.push_back( 469797*0.05362 ); Wsum.push_back( 8042720+11938137 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt120to170"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt120to170_backup" ); Xsec.push_back( 469797*0.05362  ); Wsum.push_back( 8042720+11938137 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt120to170_backup"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_170to300 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt170to300" ); Xsec.push_back( 117989*0.07335 ); Wsum.push_back( 7947158+9403070+19607775 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt170to300"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt170to300_ext1" ); Xsec.push_back( 117989*0.07335 ); Wsum.push_back( 7947158+9403070+19607775 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt170to300_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt170to300_backup" ); Xsec.push_back( 117989*0.07335 ); Wsum.push_back( 7947158+9403070+19607775 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt170to300_backup"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_300to470 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt300to470" ); Xsec.push_back( 7820.25*0.10196 ); Wsum.push_back( 7937587+16452587+24605502 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt300to470"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt300to470_ext1" ); Xsec.push_back( 7820.25*0.10196 ); Wsum.push_back( 7937587+16452587+24605502 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 3 );
        else nEvents.push_back( 3 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt300to470_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt300to470_ext2" ); Xsec.push_back( 7820.25*0.10196 ); Wsum.push_back( 7937587+16452587+24605502 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt300to470_ext2"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_470to600 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt470to600" ); Xsec.push_back( 645.528*0.12242 ); Wsum.push_back( 3851523+5663755 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt470to600"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt470to600_ext1" ); Xsec.push_back( 645.528*0.12242 ); Wsum.push_back( 3851523+5663755 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
...
//        FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    ...
    else if( pr == _EMu_QCDMuEnriched_600to800 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt600to800" ); Xsec.push_back( 187.109*0.13412 ); Wsum.push_back( 4010135+5971173+9756852 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt600to800"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt600to800_ext1" ); Xsec.push_back( 187.109*0.13412 ); Wsum.push_back( 4010135+5971173+9756852 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt600to800_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt600to800_backup" ); Xsec.push_back( 187.109*0.13412 ); Wsum.push_back( 4010135+5971173+9756852 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt600to800_backup"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_800to1000 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt800to1000" ); Xsec.push_back( 32.3486*0.14552 ); Wsum.push_back( 3962747+5838539+9966146 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt800to1000"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt800to1000_ext1" ); Xsec.push_back( 32.3486*0.14552 ); Wsum.push_back( 3962747+5838539+9966146 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 0 );
        else nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt800to1000_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt800to1000_ext2" ); Xsec.push_back( 32.3486*0.14552 ); Wsum.push_back( 3962747+5838539+9966146 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 2 );
        else nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt800to1000_ext2"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_1000toInf )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt1000toInf" ); Xsec.push_back( 10.4305*0.15544 ); Wsum.push_back( 3861436+9609820 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 3 );
        else nEvents.push_back( 3 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt1000toInf"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDMuEnriched_Pt1000toInf_ext1" ); Xsec.push_back( 10.4305*0.15544 ); Wsum.push_back( 3861436+9609820 );
        if ( ROCCORR == kTRUE ) nEvents.push_back( 1 );
        else nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt1000toInf_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if( pr == _EMu_QCDMuEnriched_Full )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";
...
//        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    ...
    else if ( pr == _EMu_QCDEMEnriched_20to30 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt20to30" ); Xsec.push_back( 557600000*0.0096 ); Wsum.push_back( 9218952.0 ); nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt20to30"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_30to50 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt30to50" ); Xsec.push_back( 136000000*0.073 ); Wsum.push_back( 4730195+6768384 ); nEvents.push_back( 0 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt30to50"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt30to50_ext1" ); Xsec.push_back( 136000000*0.073 ); Wsum.push_back( 4730195+6768384 ); nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt30to50_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_50to80 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt50to80" ); Xsec.push_back( 19800000*0.146 ); Wsum.push_back( 22337068+23474168 ); nEvents.push_back( 2 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt50to80"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt50to80_ext1" ); Xsec.push_back( 19800000*0.146 ); Wsum.push_back( 22337068+23474168 ); nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt50to80_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_80to120 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt80to120" ); Xsec.push_back( 2800000*0.125 ); Wsum.push_back( 35841780+41853502 ); nEvents.push_back( 1 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt80to120"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt80to120_ext1" ); Xsec.push_back( 2800000*0.125 ); Wsum.push_back( 35841780+41853502 ); nEvents.push_back( 6 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt80to120_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_120to170 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt120to170" ); Xsec.push_back( 477000*0.132 ); Wsum.push_back( 35817276+41954033 ); nEvents.push_back( 6 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt120to170"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt120to170_ext1" ); Xsec.push_back( 477000*0.132 ); Wsum.push_back(35817276+41954033 ); nEvents.push_back( 8 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt120to170_ext1"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_170to300 )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt170to300" ); Xsec.push_back( 114000*0.165 ); Wsum.push_back( 11540162.0 ); nEvents.push_back( 3 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt170to300"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_300toInf )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";

        Tag.push_back( "SelectedEMu_QCDEMEnriched_Pt300toInf" ); Xsec.push_back( 9000*0.15 ); Wsum.push_back( 7373633.0 ); nEvents.push_back( 8 );
        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDEMEnriched_Pt300toInf"+RocCorr+".root";
        TreeName.push_back( "DYTree" ); FileLocation.push_back( Location ); FullLocation.push_back( BaseLocation+Location );
    }
    else if ( pr == _EMu_QCDEMEnriched_Full )
    {
        isMC = kTRUE;
        Type = "BKG";
        HistLocation = "/media/sf_DATA/SelectedEMu/Histos/";
...
vector<SelProc_t> LocalFileMgr::FindProc ( TString search, Bool_t notify, Bool_t instaGet )
{
    ...
    {
        if ( srch.Contains("EMU") )
        {
            if ( srch.Contains("CDEM") || srch.Contains("CD_EM") )
            {
                // Checking for various intervals
                if ( srch.Contains("INFTO") )
                    first = _EndOf_EMu_QCDEMEnriched_Normal;
                else if ( srch.Contains("300TO") )
                    first = _EMu_QCDEMEnriched_300toInf;
                else if ( srch.Contains("170TO") )
                    first = _EMu_QCDEMEnriched_170to300;
                else if ( srch.Contains("120TO") )
                    first = _EMu_QCDEMEnriched_120to170;
                else if ( srch.Contains("80TO") )
                    first = _EMu_QCDEMEnriched_80to120;
                else if ( srch.Contains("50TO") )
                    first = _EMu_QCDEMEnriched_50to80;
                else if ( srch.Contains("30TO") )
                    first = _EMu_QCDEMEnriched_30to50;
                else if ( srch.Contains("20TO") )
                    first = _EMu_QCDEMEnriched_20to30;

                if ( srch.Contains("TOINF") )
                    last = _EMu_QCDEMEnriched_300toInf;
                else if (srch.Contains("TO1000") )
                    last = _EMu_QCDEMEnriched_300toInf;
                else if ( srch.Contains("TO800") )
                    last = _EMu_QCDEMEnriched_300toInf;
                    ...
                    last = _EMu_QCDEMEnriched_170to300;
                else if ( srch.Contains("TO170") )
                    last = _EMu_QCDEMEnriched_120to170;
                else if ( srch.Contains("TO120") )
                    last = _EMu_QCDEMEnriched_80to120;
                else if ( srch.Contains("TO80") )
                    last = _EMu_QCDEMEnriched_50to80;
                else if ( srch.Contains("TO50") )
                    last = _EMu_QCDEMEnriched_30to50;
                else if ( srch.Contains("TO30") )
                    last = _EMu_QCDEMEnriched_20to30;
                else if ( srch.Contains("TO20") )
                    last = _EndOf_EMu_WJets;
                ...
                if ( first == _EMu_QCDEMEnriched_20to30 && last == _EMu_QCDEMEnriched_300toInf )
                {
                    Result.push_back(_EMu_QCDEMEnriched_Full);
                    if ( notify == kTRUE ) cout << Procname[_EMu_QCDEMEnriched_Full] << "." << endl;
                }
                else if ( first != _None && last != _None)
                {
                    for ( SelProc_t pr=first; pr<=last; pr=next(pr) )
            ...
            }// end of if (EMu_EMEnriched)

            else if ( srch.Contains("CDMU") || srch.Contains("CD_MU") )
            {
                // Checking for various intervals
                if ( srch.Contains("INFTO") )
                    first = _EndOf_EMu_QCDMuEnriched_Normal;
                else if ( srch.Contains("1000TO") )
                    first = _EMu_QCDMuEnriched_1000toInf;
                else if ( srch.Contains("800TO") )
                    first = _EMu_QCDMuEnriched_800to1000;
                else if ( srch.Contains("600TO") )
                    first = _EMu_QCDMuEnriched_600to800;
                else if ( srch.Contains("470TO") )
                    first = _EMu_QCDMuEnriched_470to600;
                else if ( srch.Contains("300TO") )
                    first = _EMu_QCDMuEnriched_300to470;
                else if ( srch.Contains("170TO") )
                    first = _EMu_QCDMuEnriched_170to300;
                else if ( srch.Contains("120TO") )
                    first = _EMu_QCDMuEnriched_120to170;
                else if ( srch.Contains("80TO") )
                    first = _EMu_QCDMuEnriched_80to120;
                else if ( srch.Contains("50TO") )
                    first = _EMu_QCDMuEnriched_50to80;
                else if ( srch.Contains("30TO") )
                    first = _EMu_QCDMuEnriched_30to50;
                else if ( srch.Contains("20TO") )
                    first = _EMu_QCDMuEnriched_20to30;
                else if ( srch.Contains("15TO") )
                    first = _EMu_QCDMuEnriched_15to20;

                if ( srch.Contains("TOINF") )
                    last = _EMu_QCDMuEnriched_1000toInf;
                else if ( srch.Contains("TO1000") )
                    last = _EMu_QCDMuEnriched_800to1000;
                else if ( srch.Contains("TO800") )
                    last = _EMu_QCDMuEnriched_600to800;
                else if ( srch.Contains("TO600") )
                    last = _EMu_QCDMuEnriched_470to600;
                else if ( srch.Contains("TO470") )
                    last = _EMu_QCDMuEnriched_300to470;
                else if ( srch.Contains("TO300") )
                    last = _EMu_QCDMuEnriched_170to300;
                else if ( srch.Contains("TO170") )
                    last = _EMu_QCDMuEnriched_120to170;
                else if ( srch.Contains("TO120") )
                    last = _EMu_QCDMuEnriched_80to120;
                else if ( srch.Contains("TO80") )
                    last = _EMu_QCDMuEnriched_50to80;
                else if ( srch.Contains("TO50") )
                    last = _EMu_QCDMuEnriched_30to50;
                else if ( srch.Contains("TO30") )
                    last = _EMu_QCDMuEnriched_20to30;
                else if ( srch.Contains("TO20") )
                    last = _EMu_QCDMuEnriched_15to20;
                ...
                if ( first == _EMu_QCDMuEnriched_15to20 && last == _EMu_QCDMuEnriched_1000toInf )
                {
                    Result.push_back(_EMu_QCDMuEnriched_Full);
                    if ( notify == kTRUE ) cout << Procname[_EMu_QCDMuEnriched_Full] << "." << endl;
                }
                else if ( first != _None && last != _None)
                {
                    for ( SelProc_t pr=first; pr<=last; pr=next(pr) )
        ...
        }// end of if(EE_EMEnriched)

        else if ( srch.Contains("MU") )
        {
            // Checking for various intervals
            if ( srch.Contains("INFTO") )
...
void LocalFileMgr::PrepareProcNames ()
{
    ...
    Procname[_EMu_QCDMuEnriched_15to20] = "SelectedEMu_QCDMuEnriched_15to20";
    Procname[_EMu_QCDMuEnriched_20to30] = "SelectedEMu_QCDMuEnriched_20to30";
    Procname[_EMu_QCDMuEnriched_30to50] = "SelectedEMu_QCDMuEnriched_30to50";
    Procname[_EMu_QCDMuEnriched_50to80] = "SelectedEMu_QCDMuEnriched_50to80";
    Procname[_EMu_QCDMuEnriched_80to120] = "SelectedEMu_QCDMuEnriched_80to120";
    Procname[_EMu_QCDMuEnriched_120to170] = "SelectedEMu_QCDMuEnriched_120to170";
    Procname[_EMu_QCDMuEnriched_170to300] = "SelectedEMu_QCDMuEnriched_170to300";
    Procname[_EMu_QCDMuEnriched_300to470] = "SelectedEMu_QCDMuEnriched_300to470";
    Procname[_EMu_QCDMuEnriched_470to600] = "SelectedEMu_QCDMuEnriched_470to600";
    Procname[_EMu_QCDMuEnriched_600to800] = "SelectedEMu_QCDMuEnriched_600to800";
    Procname[_EMu_QCDMuEnriched_800to1000] = "SelectedEMu_QCDMuEnriched_800to1000";
    Procname[_EMu_QCDMuEnriched_1000toInf] = "SelectedEMu_QCDMuEnriched_1000toInf";
    Procname[_EndOf_EMu_QCDMuEnriched_Normal] = "EndOf_SelectedEMu_QCDMuEnriched_Normal";
    Procname[_EMu_QCDEMEnriched_20to30] = "SelectedEMu_QCDEMEnriched_20to30";
    Procname[_EMu_QCDEMEnriched_30to50] = "SelectedEMu_QCDEMEnriched_30to50";
    Procname[_EMu_QCDEMEnriched_50to80] = "SelectedEMu_QCDEMEnriched_50to80";
    Procname[_EMu_QCDEMEnriched_80to120] = "SelectedEMu_QCDEMEnriched_80to120";
    Procname[_EMu_QCDEMEnriched_120to170] = "SelectedEMu_QCDEMEnriched_120to170";
    Procname[_EMu_QCDEMEnriched_170to300] = "SelectedEMu_QCDEMEnriched_170to300";
    Procname[_EMu_QCDEMEnriched_300toInf] = "SelectedEMu_QCDEMEnriched_300toInf";
    Procname[_EndOf_EMu_QCDEMEnriched_Normal] = "EndOf_SelectedEMu_QCDEMEnriched_Normal";
    ...
    Procname[_EMu_QCDMuEnriched_Full] = "SelectedEMu_QCDMuEnriched_Full";
    Procname[_EMu_QCDEMEnriched_Full] = "SelectedEMu_QCDEMEnriched_Full";
