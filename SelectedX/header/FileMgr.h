...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(765);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(765);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation + Location);
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(467);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(467);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation + Location);
    }
...
//        BaseLocation = "root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/dpai/_v2p3_/"; // old location
        ...
        Tag.push_back("DY_M50to100"); Xsec.push_back(1873.52 * 3.0); Wsum.push_back(78026549.0/*81780984.0*/); nEvents.push_back(121265767/*122055296*/);
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(213);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(213);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(75);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(75);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(4);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(4);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(16);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(16);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(17);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(17);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(10);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(10);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(11);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(11);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(20);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(20);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(8);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(8);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _DY_Full)
    {
...
//        NtupleName.push_back("ntuple_skim_sig_"); nNtuples.push_back(467);
        ...
        Tag.push_back("DY_M50to100"); Xsec.push_back(1873.52 * 3.0); Wsum.push_back(78026549.0); nEvents.push_back(121265767);
//        Location = "DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYLL_M50toInf/180326_143143/0000/";
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(982);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(982);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(1190);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(1190);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(518);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(518);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(161);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(161);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _tbarW)
    {
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(66);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(66);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _WZ)
    {
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(128);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(128);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _WW)
    {
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(300); // One ntuple missing in v2.7 (299)
        ...
        Tag.push_back("WJetsToLNu_ext"); Xsec.push_back(61526.7); Wsum.push_back(16497009.0 + 161144203.0 + 253933112.0); nEvents.push_back(235575647);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(2672);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(2672);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(3568);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(3568);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(112);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(112);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(34);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(34);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(58);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(58);
       TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(186);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(186);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(148);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(148);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(271);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(271);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(279);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(279);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(316);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(316);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(306);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(306);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(93);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(93);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(93);
    ...
    else if (pr == _GJets_20to100)
    {
        ...
        Tag.push_back("GammaJets_Pt20to100"); Xsec.push_back(137800.0); Wsum.push_back(173523853932.3); nEvents.push_back(498342); // Using actual wsum (weights not changed to +-1)
        Location = "GJets_Pt20to100_Sherpa/";
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(60);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(60);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _GJets_100to200)
    {
        ...
        Tag.push_back("GammaJets_Pt100to200"); Xsec.push_back(1024.0); Wsum.push_back(1304261585.6); nEvents.push_back(496553);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(17);
    ...
    else if (pr == _GJets_200to500)
    {
        ...
        Tag.push_back("GammaJets_Pt200to500"); Xsec.push_back(68.66); Wsum.push_back(82977002.3); nEvents.push_back(476054);
        Location = "GJets_Pt200to500_Sherpa/";
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(19);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(19);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _GJets_500to1000)
    {
        ...
        Tag.push_back("GammaJets_Pt500to1000"); Xsec.push_back(1.014); Wsum.push_back(1420832.5); nEvents.push_back(484865);
        Location = "GJets_Pt500to1000_Sherpa/";
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(38);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(38);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(56);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(56);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(30);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(30);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
    }
    else if (pr == _GJets_Full)
    {
        ...
        Tag.push_back("GammaJets_Pt20to100"); Xsec.push_back(137800.0); Wsum.push_back(173523853932.3); nEvents.push_back(498342);
        Location = "GJets_Pt20to100_Sherpa/";
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(60);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(60);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(2672);
        ...
        Tag.push_back("WJetsToLNu_ext2v5"); Xsec.push_back(61526.7); Wsum.push_back(16497009.0 + 161144203.0 + 253933112.0); nEvents.push_back(177139200);
        Location = "WJetsToLNu_amcatnlo_ext2v5/";
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(3568);
        NtupleName.push_back("ntuple_mc_"); nNtuples.push_back(3568);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);
...
//        NtupleName.push_back("ntuple_skim_mc_"); nNtuples.push_back(30);
    ...
    else if (pr == _DoubleEG_B)
    {
        ...
        Tag.push_back("DoubleEG_B"); nEvents.push_back(136656970);
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(452);
    ...
    else if (pr == _DoubleEG_G)
    {
        ...
        Tag.push_back("DoubleEG_G"); nEvents.push_back(76534470);
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(1068);
    ...
    else if (pr == _DoubleEG_H)
    {
        ...
        Tag.push_back("DoubleEG_Hver2"); nEvents.push_back(80523734);
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(1318);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016B/201022_090619/0000/*.root");
        Tag.push_back("SinglePhoton_B"); nEvents.push_back(53774727);
        NtupleName.push_back("ntuple_data_"); nNtuples.push_back(1318);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location);
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016B/201022_090619/0001/*.root");
    }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(435);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016C/201230_133348/0000/*.root");
    }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(729);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016D/201230_133432/0000/*.root");
    }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(620);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016E/201230_133516/0000/*.root");
    }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(452);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016F/201230_133600/0000/*.root");
    }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(1068);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016G/201230_133648/0000/*.root");
        Tag.push_back("SinglePhoton_G"); nEvents.push_back(31866122);
        NtupleName.push_back("ntuple_data_"); nNtuples.push_back(1068);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location);
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016G/201230_133648/0001/*.root");
   }
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(1156);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016Hver2/201230_134622/0000/*.root");
        Tag.push_back("SinglePhoton_Hver2"); nEvents.push_back(32767792);
        NtupleName.push_back("ntuple_data_"); nNtuples.push_back(1156);
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location);
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016Hver2/201230_134622/0001/*.root");
...
//        NtupleName.push_back("ntuple_skim_"); nNtuples.push_back(31);
        ...
        TreeName.push_back("recoTree/DYTree"); FileLocation.push_back(Location); //FullLocation.push_back(BaseLocation+Location);
        //TEST
        FullLocation.push_back("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/mambroza/v2p9/TEST_v2.10.4/SinglePhoton/crab_SinglePhoton_Run2016Hver3/201230_134704/0000/*.root");
    }
