...
//        Location = "QCD_Pt-300toInf_EMEnriched_TuneCUETP8M1_13TeV_pythia8/crab_QCDEMEnriched_Pt300toInf/180326_145836/0000/";
    ...
    else if (pr == _GJets_20to100)
    {
        ...
        Tag.push_back("GammaJets_Pt20to100"); Xsec.push_back(137800.0); Wsum.push_back(498342.0); nEvents.push_back(498342);
    ...
    else if (pr == _GJets_100to200)
    {
        ...
        Tag.push_back("GammaJets_Pt100to200"); Xsec.push_back(1024.0); Wsum.push_back(496553.0); nEvents.push_back(496553);
    ...
    else if (pr == _GJets_200to500)
    {
        ...
        Tag.push_back("GammaJets_Pt200to500"); Xsec.push_back(68.66); Wsum.push_back(476054.0); nEvents.push_back(476054);
    ...
    else if (pr == _GJets_500to1000)
    {
        ...
        Tag.push_back("GammaJets_Pt500to1000"); Xsec.push_back(1.014); Wsum.push_back(484865.0); nEvents.push_back(484865);
    ...
    else if (pr == _GJets_1000to2000)
    {
        ...
        Tag.push_back("GammaJets_Pt1000to2000"); Xsec.push_back(0.02092); Wsum.push_back(395409.0); nEvents.push_back(395409);
    ...
    else if (pr == _GJets_2000to5000)
    {
        ...
        Tag.push_back("GammaJets_Pt2000to5000"); Xsec.push_back(7.476e-05); Wsum.push_back(299739.0); nEvents.push_back(299739);
