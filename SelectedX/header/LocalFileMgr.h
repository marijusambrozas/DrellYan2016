...
void LocalFileMgr::SetProc (SelProc_t pr, Bool_t ClearOld)
{
    ...
    else if(pr == _MuMu_QCDMuEnriched_15to20)
    {
        ...
        Tag.push_back("SelectedMuMu_QCDMuEnriched_Pt15to20"); Xsec.push_back(1273190000*0.003); Wsum.push_back(4141251.0);
    ...
    else if(pr == _MuMu_QCDMuEnriched_20to30)
    {
        ...
        Tag.push_back("SelectedMuMu_QCDMuEnriched_Pt20to30"); Xsec.push_back(558528000*0.0053); Wsum.push_back(31302080.0);
        if (ROCCORR == kTRUE) nEvents.push_back(0);
        else nEvents.push_back(0);
...
//        Tag.push_back("SelectedEMu_QCDMuEnriched_Pt15to20"); Xsec.push_back(1273190000*0.003); Wsum.push_back(1.0); nEvents.push_back(0);
//        Location = "SelectedEMu/MC_bkg/SelectedEMu_QCDMuEnriched_Pt15to20"+RocCorr+".root";
//        TreeName.push_back("DYTree"); FileLocation.push_back(Location); FullLocation.push_back(BaseLocation+Location);

//        Tag.push_back("SelectedEMu_QCDMuEnriched_Pt20to30"); Xsec.push_back(558528000*0.0053); Wsum.push_back(1.0); nEvents.push_back(0);
