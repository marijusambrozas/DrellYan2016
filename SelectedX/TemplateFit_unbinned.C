...
void E_Tfit(Int_t type)
{
    ...
    TH1D *h_barrel_MC_ctrl[_EndOf_Data_Special], *h_barrel_MC_nume[_EndOf_Data_Special],
         *h_endcap_MC_ctrl[_EndOf_Data_Special], *h_endcap_MC_nume[_EndOf_Data_Special],
         *h_barrel_data_ctrl, *h_barrel_data_nume, *h_endcap_data_ctrl, *h_endcap_data_nume;
...
//----------------------------- MC bkg ------------------------------------
    ...
    {
        TFile *file;
        file = new TFile("/media/sf_DATA/FR/Electron/FR_Hist_E_"+fm.Procname[pr1]+".root", "READ");

        file->GetObject("h_PFiso_barrel_ctrl", h_barrel_MC_ctrl[pr1]);
        file->GetObject("h_PFiso_endcap_ctrl", h_endcap_MC_ctrl[pr1]);
    ...
    for (Process_t pr = _DY_10to50; pr <= _DY_2000to3000; pr=next(pr))
    {
        ...
        file->GetObject("h_PFiso_barrel_ctrl", h_barrel_MC_ctrl[pr]);
        file->GetObject("h_PFiso_endcap_ctrl", h_endcap_MC_ctrl[pr]);
    ...
    for (Process_t pr = _QCDEMEnriched_20to30; pr <= _QCDEMEnriched_300toInf; pr=next(pr))
    {
        ...
        {
            h_barrel_MC_ctrl[_QCDEMEnriched_Full] = ((TH1D*)(h_barrel_MC_ctrl[pr]->Clone("h_barrel_MC_ctrl_QCD")));
            h_endcap_MC_ctrl[_QCDEMEnriched_Full] = ((TH1D*)(h_endcap_MC_ctrl[pr]->Clone("h_endcap_MC_ctrl_QCD")));
            h_barrel_MC_nume[_QCDEMEnriched_Full] = ((TH1D*)(h_barrel_MC_nume[pr]->Clone("h_barrel_MC_nume_QCD")));
            h_endcap_MC_nume[_QCDEMEnriched_Full] = ((TH1D*)(h_endcap_MC_nume[pr]->Clone("h_endcap_MC_nume_QCD")));
            h_barrel_MC_ctrl[_QCDEMEnriched_Full]->SetDirectory(0);
            h_endcap_MC_ctrl[_QCDEMEnriched_Full]->SetDirectory(0);
            h_barrel_MC_nume[_QCDEMEnriched_Full]->SetDirectory(0);
            h_endcap_MC_nume[_QCDEMEnriched_Full]->SetDirectory(0);
        }
        else
        {
            h_barrel_MC_ctrl[_QCDEMEnriched_Full]->Add(h_barrel_MC_ctrl[pr]);
            h_endcap_MC_ctrl[_QCDEMEnriched_Full]->Add(h_endcap_MC_ctrl[pr]);
            h_barrel_MC_nume[_QCDEMEnriched_Full]->Add(h_barrel_MC_nume[pr]);
            h_endcap_MC_nume[_QCDEMEnriched_Full]->Add(h_endcap_MC_nume[pr]);
        }
        file->Close();
    }
...
//--------------------------------------- DATA -----------------------------------------------------
    ...
    for (Process_t pr=_SinglePhoton_B; pr<=_SinglePhoton_H; pr=next(pr))
    {
        ...
        {
            file->GetObject("h_PFiso_barrel_ctrl", h_barrel_data_ctrl);
            file->GetObject("h_PFiso_endcap_ctrl", h_endcap_data_ctrl);
        ...
        {
            file->GetObject("h_PFiso_barrel_ctrl", h_temp[0]);
            file->GetObject("h_PFiso_endcap_ctrl", h_temp[1]);
            ...
            h_barrel_data_ctrl->Add(h_temp[0]);
            h_endcap_data_ctrl->Add(h_temp[1]);
...
// ######################## MODEL BUILDING ##########################
    ...
    // Making RooDataHist
    RooRealVar iso_nume("iso", "PFiso/p_{T}", 0, 0.5);
    RooRealVar iso_ctrl("iso", "PFiso/p_{T}", 0, 5);

    RooDataHist *rh_barrel_nume_QCD = new RooDataHist("rh_barrel_nume_QCD", "RooHist_barrel_nume_QCD", iso_nume, h_barrel_MC_nume[_QCDEMEnriched_Full]);
    ...
    RooDataHist *rh_endcap_nume_QCD = new RooDataHist("rh_endcap_nume_QCD", "RooHist_endcap_nume_QCD", iso_nume, h_endcap_MC_nume[_QCDEMEnriched_Full]);
    ...
    RooDataHist *rh_barrel_ctrl_QCD = new RooDataHist("rh_barrel_ctrl_QCD", "RooHist_barrel_ctrl_QCD", iso_ctrl, h_barrel_MC_ctrl[_QCDEMEnriched_Full]);
    ...
    RooDataHist *rh_endcap_ctrl_QCD = new RooDataHist("rh_endcap_ctrl_QCD", "RooHist_endcap_ctrl_QCD", iso_ctrl, h_endcap_MC_ctrl[_QCDEMEnriched_Full]);
    ...
    RooHistPdf *pdf_barrel_ctrl_QCD   = new RooHistPdf("pdf_barrel_ctrl_QCD",   "Denominator barrel MC QCD template",    iso_ctrl, *rh_barrel_ctrl_QCD, 0);
    RooHistPdf *pdf_barrel_ctrl_WJets = new RooHistPdf("pdf_barrel_ctrl_WJets", "Denominator barrel MC W+Jets template", iso_ctrl, *rh_barrel_ctrl_WJets, 0);
    RooHistPdf *pdf_barrel_ctrl_DY    = new RooHistPdf("pdf_barrel_ctrl_DY",    "Denominator barrel MC DY template",     iso_ctrl, *rh_barrel_ctrl_DY, 0);
    RooHistPdf *pdf_barrel_ctrl_ttbar = new RooHistPdf("pdf_barrel_ctrl_ttbar", "Denominator barrel MC ttbar template",  iso_ctrl, *rh_barrel_ctrl_ttbar, 0);
    RooHistPdf *pdf_barrel_ctrl_tW    = new RooHistPdf("pdf_barrel_ctrl_tW",    "Denominator barrel MC tW template",     iso_ctrl, *rh_barrel_ctrl_tW, 0);
    RooHistPdf *pdf_barrel_ctrl_tbarW = new RooHistPdf("pdf_barrel_ctrl_tbarW", "Denominator barrel MC tbarW template",  iso_ctrl, *rh_barrel_ctrl_tbarW, 0);
    RooHistPdf *pdf_barrel_ctrl_WW    = new RooHistPdf("pdf_barrel_ctrl_WW",    "Denominator barrel MC WW template",     iso_ctrl, *rh_barrel_ctrl_WW, 0);
    RooHistPdf *pdf_barrel_ctrl_WZ    = new RooHistPdf("pdf_barrel_ctrl_WZ",    "Denominator barrel MC WZ template",     iso_ctrl, *rh_barrel_ctrl_WZ, 0);
    RooHistPdf *pdf_barrel_ctrl_ZZ    = new RooHistPdf("pdf_barrel_ctrl_ZZ",    "Denominator barrel MC ZZ template",     iso_ctrl, *rh_barrel_ctrl_ZZ, 0);

    RooHistPdf *pdf_endcap_ctrl_QCD   = new RooHistPdf("pdf_endcap_ctrl_QCD",   "Denominator endcap MC QCD template",    iso_ctrl, *rh_endcap_ctrl_QCD, 0);
    RooHistPdf *pdf_endcap_ctrl_WJets = new RooHistPdf("pdf_endcap_ctrl_WJets", "Denominator endcap MC W+Jets template", iso_ctrl, *rh_endcap_ctrl_WJets, 0);
    RooHistPdf *pdf_endcap_ctrl_DY    = new RooHistPdf("pdf_endcap_ctrl_DY",    "Denominator endcap MC DY template",     iso_ctrl, *rh_endcap_ctrl_DY, 0);
    RooHistPdf *pdf_endcap_ctrl_ttbar = new RooHistPdf("pdf_endcap_ctrl_ttbar", "Denominator endcap MC ttbar template",  iso_ctrl, *rh_endcap_ctrl_ttbar, 0);
    RooHistPdf *pdf_endcap_ctrl_tW    = new RooHistPdf("pdf_endcap_ctrl_tW",    "Denominator endcap MC tW template",     iso_ctrl, *rh_endcap_ctrl_tW, 0);
    RooHistPdf *pdf_endcap_ctrl_tbarW = new RooHistPdf("pdf_endcap_ctrl_tbarW", "Denominator endcap MC tbarW template",  iso_ctrl, *rh_endcap_ctrl_tbarW, 0);
    RooHistPdf *pdf_endcap_ctrl_WW    = new RooHistPdf("pdf_endcap_ctrl_WW",    "Denominator endcap MC WW template",     iso_ctrl, *rh_endcap_ctrl_WW, 0);
    RooHistPdf *pdf_endcap_ctrl_WZ    = new RooHistPdf("pdf_endcap_ctrl_WZ",    "Denominator endcap MC WZ template",     iso_ctrl, *rh_endcap_ctrl_WZ, 0);
    RooHistPdf *pdf_endcap_ctrl_ZZ    = new RooHistPdf("pdf_endcap_ctrl_ZZ",    "Denominator endcap MC ZZ template",     iso_ctrl, *rh_endcap_ctrl_ZZ, 0);
...
//    Double_t N_barrel_ctrl_ttbar = (L_B2H * 831.76 / 154948878) * h_barrel_MC_ctrl[_ttbar]->Integral();
//    Double_t N_endcap_ctrl_ttbar = (L_B2H * 831.76 / 154948878) * h_endcap_MC_ctrl[_ttbar]->Integral();
...
//    Double_t n_barrel_ctrl_WJets = (L_B2H * 61526 / 162787688) * h_barrel_MC_ctrl[_WJets]->Integral();
//    Double_t n_endcap_ctrl_WJets = (L_B2H * 61526 / 162787688) * h_endcap_MC_ctrl[_WJets]->Integral();
...
//    Double_t N_barrel_ctrl_DY = (L_B2H * 3 * 1952.68432327 / 81780984) * h_barrel_MC_ctrl[_DY_50to100]->Integral();
//    Double_t N_endcap_ctrl_DY = (L_B2H * 3 * 1952.68432327 / 81780984) * h_endcap_MC_ctrl[_DY_50to100]->Integral();
...
//    Double_t N_barrel_ctrl_QCD = (L_B2H * xsec_QCD / wsum_QCD) * h_barrel_MC_ctrl[_QCDMuEnriched_Full]->Integral();
//    Double_t N_endcap_ctrl_QCD = (L_B2H * xsec_QCD / wsum_QCD) * h_endcap_MC_ctrl[_QCDMuEnriched_Full]->Integral();
    Double_t N_barrel_nume_QCD = h_barrel_MC_nume[_QCDEMEnriched_Full]->Integral();
    Double_t N_endcap_nume_QCD = h_endcap_MC_nume[_QCDEMEnriched_Full]->Integral();
    Double_t N_barrel_ctrl_QCD = h_barrel_MC_ctrl[_QCDEMEnriched_Full]->Integral();
    Double_t N_endcap_ctrl_QCD = h_endcap_MC_ctrl[_QCDEMEnriched_Full]->Integral();
...
//    Double_t N_barrel_ctrl_tW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_barrel_MC_ctrl[_tW]->Integral();
//    Double_t N_endcap_ctrl_tW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_endcap_MC_ctrl[_tW]->Integral();
...
//    Double_t N_barrel_ctrl_tbarW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_barrel_MC_ctrl[_tbarW]->Integral();
//    Double_t N_endcap_ctrl_tbarW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_endcap_MC_ctrl[_tbarW]->Integral();
...
//    Double_t N_barrel_ctrl_WW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_barrel_MC_ctrl[_WW]->Integral();
//    Double_t N_endcap_ctrl_WW = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_endcap_MC_ctrl[_WW]->Integral();
...
//    Double_t N_barrel_ctrl_WZ = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_barrel_MC_ctrl[_WZ]->Integral();
//    Double_t N_endcap_ctrl_WZ = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_endcap_MC_ctrl[_WZ]->Integral();
...
//    Double_t N_barrel_ctrl_ZZ = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_barrel_MC_ctrl[_ZZ]->Integral();
//    Double_t N_endcap_ctrl_ZZ = (L_B2H * Mgr.Xsec[0] / Mgr.Wsum[0]) * h_endcap_MC_ctrl[_ZZ]->Integral();
    ...
    Double_t N_barrel_ctrl_total = N_barrel_ctrl_ttbar + N_barrel_ctrl_WJets + N_barrel_ctrl_DY + N_barrel_ctrl_QCD +
                                   N_barrel_ctrl_tW    + N_barrel_ctrl_tbarW + N_barrel_ctrl_WW + N_barrel_ctrl_WZ  + N_barrel_ctrl_ZZ;
    Double_t N_endcap_ctrl_total = N_endcap_ctrl_ttbar + N_endcap_ctrl_WJets + N_endcap_ctrl_DY + N_endcap_ctrl_QCD +
                                   N_endcap_ctrl_tW    + N_endcap_ctrl_tbarW + N_endcap_ctrl_WW + N_endcap_ctrl_WZ  + N_endcap_ctrl_ZZ;
    ...
    RooRealVar n_barrel_ctrl_ttbar("n_barrel_ctrl_ttbar", "n_barrel_ctrl_ttbar", Nnorm_barrel_ctrl_ttbar, Nnorm_barrel_ctrl_ttbar*0.95, Nnorm_barrel_ctrl_ttbar*1.05);
    RooRealVar n_endcap_ctrl_ttbar("n_endcap_ctrl_ttbar", "n_endcap_ctrl_ttbar", Nnorm_endcap_ctrl_ttbar, Nnorm_endcap_ctrl_ttbar*0.95, Nnorm_endcap_ctrl_ttbar*1.05);
    ...
    RooRealVar n_barrel_ctrl_DY("n_barrel_ctrl_DY", "n_barrel_ctrl_DY", Nnorm_barrel_ctrl_DY, Nnorm_barrel_ctrl_DY*0.95, Nnorm_barrel_ctrl_DY*1.05);
    RooRealVar n_endcap_ctrl_DY("n_endcap_ctrl_DY", "n_endcap_ctrl_DY", Nnorm_endcap_ctrl_DY, Nnorm_endcap_ctrl_DY*0.95, Nnorm_endcap_ctrl_DY*1.05);
    ...
    RooRealVar n_barrel_ctrl_tW("n_barrel_ctrl_tW", "n_barrel_ctrl_tW", Nnorm_barrel_ctrl_tW, Nnorm_barrel_ctrl_tW*0.95, Nnorm_barrel_ctrl_tW*1.05);
    RooRealVar n_endcap_ctrl_tW("n_endcap_ctrl_tW", "n_endcap_ctrl_tW", Nnorm_endcap_ctrl_tW, Nnorm_endcap_ctrl_tW*0.95, Nnorm_endcap_ctrl_tW*1.05);
    ...
    RooRealVar n_barrel_ctrl_tbarW("n_barrel_ctrl_tbarW", "n_barrel_ctrl_tbarW", Nnorm_barrel_ctrl_tbarW, Nnorm_barrel_ctrl_tbarW*0.95, Nnorm_barrel_ctrl_tbarW*1.05);
    RooRealVar n_endcap_ctrl_tbarW("n_endcap_ctrl_tbarW", "n_endcap_ctrl_tbarW", Nnorm_endcap_ctrl_tbarW, Nnorm_endcap_ctrl_tbarW*0.95, Nnorm_endcap_ctrl_tbarW*1.05);
    ...
    RooRealVar n_barrel_ctrl_WW("n_barrel_ctrl_WW", "n_barrel_ctrl_WW", Nnorm_barrel_ctrl_WW, Nnorm_barrel_ctrl_WW*0.95, Nnorm_barrel_ctrl_WW*1.05);
    RooRealVar n_endcap_ctrl_WW("n_endcap_ctrl_WW", "n_endcap_ctrl_WW", Nnorm_endcap_ctrl_WW, Nnorm_endcap_ctrl_WW*0.95, Nnorm_endcap_ctrl_WW*1.05);
    ...
    RooRealVar n_barrel_ctrl_WZ("n_barrel_ctrl_WZ", "n_barrel_ctrl_WZ", Nnorm_barrel_ctrl_WZ, Nnorm_barrel_ctrl_WZ*0.95, Nnorm_barrel_ctrl_WZ*1.05);
    RooRealVar n_endcap_ctrl_WZ("n_endcap_ctrl_WZ", "n_endcap_ctrl_WZ", Nnorm_endcap_ctrl_WZ, Nnorm_endcap_ctrl_WZ*0.95, Nnorm_endcap_ctrl_WZ*1.05);
    ...
    RooRealVar n_barrel_ctrl_ZZ("n_barrel_ctrl_ZZ", "n_barrel_ctrl_ZZ", Nnorm_barrel_ctrl_ZZ, Nnorm_barrel_ctrl_ZZ*0.95, Nnorm_barrel_ctrl_ZZ*1.05);
    RooRealVar n_endcap_ctrl_ZZ("n_endcap_ctrl_ZZ", "n_endcap_ctrl_ZZ", Nnorm_endcap_ctrl_ZZ, Nnorm_endcap_ctrl_ZZ*0.95, Nnorm_endcap_ctrl_ZZ*1.05);
...
//    RooRealVar n_barrel_ctrl_ttbar("n_barrel_ctrl_ttbar", "n_barrel_ctrl_ttbar", Nnorm_barrel_ctrl_ttbar, Nnorm_barrel_ctrl_ttbar*0.9, Nnorm_barrel_ctrl_ttbar*1.1);
//    RooRealVar n_endcap_ctrl_ttbar("n_endcap_ctrl_ttbar", "n_endcap_ctrl_ttbar", Nnorm_endcap_ctrl_ttbar, Nnorm_endcap_ctrl_ttbar*0.9, Nnorm_endcap_ctrl_ttbar*1.1);
...
//    RooRealVar n_barrel_ctrl_WJets("n_barrel_ctrl_WJets", "n_barrel_ctrl_WJets", Nnorm_barrel_ctrl_WJets, Nnorm_barrel_ctrl_WJets*0.9, Nnorm_barrel_ctrl_WJets*1.1);
//    RooRealVar n_endcap_ctrl_WJets("n_endcap_ctrl_WJets", "n_endcap_ctrl_WJets", Nnorm_endcap_ctrl_WJets, Nnorm_endcap_ctrl_WJets*0.9, Nnorm_endcap_ctrl_WJets*1.1);
...
//    RooRealVar n_barrel_ctrl_DY("n_barrel_ctrl_DY", "n_barrel_ctrl_DY", Nnorm_barrel_ctrl_DY, Nnorm_barrel_ctrl_DY*0.9, Nnorm_barrel_ctrl_DY*1.1);
//    RooRealVar n_endcap_ctrl_DY("n_endcap_ctrl_DY", "n_endcap_ctrl_DY", Nnorm_endcap_ctrl_DY, Nnorm_endcap_ctrl_DY*0.9, Nnorm_endcap_ctrl_DY*1.1);
...
//    RooRealVar n_barrel_ctrl_tW("n_barrel_ctrl_tW", "n_barrel_ctrl_tW", Nnorm_barrel_ctrl_tW, Nnorm_barrel_ctrl_tW*0.9, Nnorm_barrel_ctrl_tW*1.1);
//    RooRealVar n_endcap_ctrl_tW("n_endcap_ctrl_tW", "n_endcap_ctrl_tW", Nnorm_endcap_ctrl_tW, Nnorm_endcap_ctrl_tW*0.9, Nnorm_endcap_ctrl_tW*1.1);
...
//    RooRealVar n_barrel_ctrl_tbarW("n_barrel_ctrl_tbarW", "n_barrel_ctrl_tbarW", Nnorm_barrel_ctrl_tbarW, Nnorm_barrel_ctrl_tbarW*0.9, Nnorm_barrel_ctrl_tbarW*1.1);
//    RooRealVar n_endcap_ctrl_tbarW("n_endcap_ctrl_tbarW", "n_endcap_ctrl_tbarW", Nnorm_endcap_ctrl_tbarW, Nnorm_endcap_ctrl_tbarW*0.9, Nnorm_endcap_ctrl_tbarW*1.1);
...
//    RooRealVar n_barrel_ctrl_WW("n_barrel_ctrl_WW", "n_barrel_ctrl_WW", Nnorm_barrel_ctrl_WW, Nnorm_barrel_ctrl_WW*0.9, Nnorm_barrel_ctrl_WW*1.1);
//    RooRealVar n_endcap_ctrl_WW("n_endcap_ctrl_WW", "n_endcap_ctrl_WW", Nnorm_endcap_ctrl_WW, Nnorm_endcap_ctrl_WW*0.9, Nnorm_endcap_ctrl_WW*1.1);
...
//    RooRealVar n_barrel_ctrl_WZ("n_barrel_ctrl_WZ", "n_barrel_ctrl_WZ", Nnorm_barrel_ctrl_WZ, Nnorm_barrel_ctrl_WZ*0.9, Nnorm_barrel_ctrl_WZ*1.1);
//    RooRealVar n_endcap_ctrl_WZ("n_endcap_ctrl_WZ", "n_endcap_ctrl_WZ", Nnorm_endcap_ctrl_WZ, Nnorm_endcap_ctrl_WZ*0.9, Nnorm_endcap_ctrl_WZ*1.1);
...
//    RooRealVar n_barrel_ctrl_ZZ("n_barrel_ctrl_ZZ", "n_barrel_ctrl_ZZ", Nnorm_barrel_ctrl_ZZ, Nnorm_barrel_ctrl_ZZ*0.9, Nnorm_barrel_ctrl_ZZ*1.1);
//    RooRealVar n_endcap_ctrl_ZZ("n_endcap_ctrl_ZZ", "n_endcap_ctrl_ZZ", Nnorm_endcap_ctrl_ZZ, Nnorm_endcap_ctrl_ZZ*0.9, Nnorm_endcap_ctrl_ZZ*1.1);
    ...
    RooAddPdf model_barrel_ctrl("model_barrel_ctrl", "model_barrel_ctrl", RooArgList(*pdf_barrel_ctrl_QCD,   *pdf_barrel_ctrl_WJets, *pdf_barrel_ctrl_DY,
                                                                                     *pdf_barrel_ctrl_ttbar, *pdf_barrel_ctrl_tW,    *pdf_barrel_ctrl_tbarW,
                                                                                     *pdf_barrel_ctrl_WW,    *pdf_barrel_ctrl_WZ,    *pdf_barrel_ctrl_ZZ),
                                RooArgList(n_barrel_ctrl_QCD,   n_barrel_ctrl_WJets, n_barrel_ctrl_DY, n_barrel_ctrl_ttbar, n_barrel_ctrl_tW,
                                           n_barrel_ctrl_tbarW, n_barrel_ctrl_WW,    n_barrel_ctrl_WZ, n_barrel_ctrl_ZZ));

    RooAddPdf model_endcap_ctrl("model_endcap_ctrl", "model_endcap_ctrl", RooArgList(*pdf_endcap_ctrl_QCD,   *pdf_endcap_ctrl_WJets, *pdf_endcap_ctrl_DY,
                                                                                     *pdf_endcap_ctrl_ttbar, *pdf_endcap_ctrl_tW,    *pdf_endcap_ctrl_tbarW,
                                                                                     *pdf_endcap_ctrl_WW,    *pdf_endcap_ctrl_WZ,    *pdf_endcap_ctrl_ZZ),
                                RooArgList(n_endcap_ctrl_QCD,   n_endcap_ctrl_WJets, n_endcap_ctrl_DY, n_endcap_ctrl_ttbar, n_endcap_ctrl_tW,
                                           n_endcap_ctrl_tbarW, n_endcap_ctrl_WW,    n_endcap_ctrl_WZ, n_endcap_ctrl_ZZ));
    ...
    rh_barrel_nume_data->plotOn(frame_barrel_nume, DataError(RooAbsData::SumW2));
    frame_barrel_nume->GetYaxis()->SetRangeUser(1, 2e10);
    ...
    rh_endcap_nume_data->plotOn(frame_endcap_nume, DataError(RooAbsData::SumW2));
    frame_endcap_nume->GetYaxis()->SetRangeUser(1, 2e10);
    ...
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW,"
                                                           "pdf_barrel_ctrl_tbarW,pdf_barrel_ctrl_ttbar,pdf_barrel_ctrl_DY,"
                                                           "pdf_barrel_ctrl_WJets,pdf_barrel_ctrl_QCD"),
                             LineColor(0), FillColor(kRed+3), DrawOption("F"));
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW,"
                                                           "pdf_barrel_ctrl_tbarW,pdf_barrel_ctrl_ttbar,pdf_barrel_ctrl_DY,"
                                                           "pdf_barrel_ctrl_WJets"),
                             LineColor(0), FillColor(kRed-2), DrawOption("F"));
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW,"
                                                           "pdf_barrel_ctrl_tbarW,pdf_barrel_ctrl_ttbar,pdf_barrel_ctrl_DY"),
                             LineColor(0), FillColor(kOrange), DrawOption("F"));
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW,"
                                                           "pdf_barrel_ctrl_tbarW,pdf_barrel_ctrl_ttbar"),
                             LineColor(0), FillColor(kCyan+2), DrawOption("F"));
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW,"
                                                           "pdf_barrel_ctrl_tbarW"),
                             LineColor(0), FillColor(kGreen-2), DrawOption("F"));
    model_barrel_ctrl.plotOn(frame_barrel_ctrl, Components("pdf_barrel_ctrl_ZZ,pdf_barrel_ctrl_WZ,pdf_barrel_ctrl_WW,pdf_barrel_ctrl_tW"),
                             LineColor(0), FillColor(kGreen+2), DrawOption("F"));
    ...
    rh_barrel_ctrl_data->plotOn(frame_barrel_ctrl, DataError(RooAbsData::SumW2));
    frame_barrel_ctrl->GetYaxis()->SetRangeUser(1, 2e10);
    ...
    cout << "Data integral: "   << N_barrel_ctrl_data << endl;
    ...
    h_barrel_ctrl_ratio->GetXaxis()->SetTitle("I_{#lower[-0.2]{PF}}^{rel.} (#mu_{#lower[-0.4]{barrel}}^{ctrl})");
    ...
    h_barrel_ctrl_ratio->SetMaximum(1.3);
    h_barrel_ctrl_ratio->SetMinimum(0.7);
    h_barrel_ctrl_ratio->GetYaxis()->SetNdivisions(7);
    ...
    // Red line at Data/MC=1
    TH1D *h_line_ctrl = ((TH1D*)(h_barrel_ctrl_ratio->Clone("h_line_ctrl")));
    ...
    cout << "Normalized chi2: " << chi2_barrel_ctrl->getVal() / ((Double_t)h_barrel_data_ctrl->GetNbinsX()) << endl;
    ...
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW,"
                                                           "pdf_endcap_ctrl_tbarW,pdf_endcap_ctrl_ttbar,pdf_endcap_ctrl_DY,"
                                                           "pdf_endcap_ctrl_WJets,pdf_endcap_ctrl_QCD"),
                             LineColor(0), FillColor(kRed+3), DrawOption("F"));
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW,"
                                                           "pdf_endcap_ctrl_tbarW,pdf_endcap_ctrl_ttbar,pdf_endcap_ctrl_DY,"
                                                           "pdf_endcap_ctrl_WJets"),
                             LineColor(0), FillColor(kRed-2), DrawOption("F"));
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW,"
                                                           "pdf_endcap_ctrl_tbarW,pdf_endcap_ctrl_ttbar,pdf_endcap_ctrl_DY"),
                             LineColor(0), FillColor(kOrange), DrawOption("F"));
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW,"
                                                           "pdf_endcap_ctrl_tbarW,pdf_endcap_ctrl_ttbar"),
                             LineColor(0), FillColor(kCyan+2), DrawOption("F"));
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW,"
                                                           "pdf_endcap_ctrl_tbarW"),
                             LineColor(0), FillColor(kGreen-2), DrawOption("F"));
    model_endcap_ctrl.plotOn(frame_endcap_ctrl, Components("pdf_endcap_ctrl_ZZ,pdf_endcap_ctrl_WZ,pdf_endcap_ctrl_WW,pdf_endcap_ctrl_tW"),
                             LineColor(0), FillColor(kGreen+2), DrawOption("F"));
    ...
    rh_endcap_ctrl_data->plotOn(frame_endcap_ctrl, DataError(RooAbsData::SumW2));
    frame_endcap_ctrl->GetYaxis()->SetRangeUser(1, 2e10);
    ...
    cout << "Data integral: "   << N_endcap_ctrl_data << endl;
    ...
    h_endcap_ctrl_ratio->GetXaxis()->SetTitle("I_{#lower[-0.2]{PF}}^{rel.} (#mu_{#lower[-0.4]{endcap}}^{ctrl})");
    ...
    h_endcap_ctrl_ratio->SetMaximum(1.3);
    h_endcap_ctrl_ratio->SetMinimum(0.7);
    h_endcap_ctrl_ratio->GetYaxis()->SetNdivisions(7);
