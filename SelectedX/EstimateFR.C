...
void Mu_EstFRandPR_MC()
{
    ...
    h_FR_nJet_barrel_nume[1]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
    ...
    h_FR_nJet_endcap_nume[1]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
    ...
    h_FR_nJet_endcap2_nume[1]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
    ...
    h_PR_nJet_barrel_nume[0]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
    ...
    h_PR_nJet_endcap_nume[0]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
    ...
    h_PR_nJet_endcap2_nume[0]->GetXaxis()->SetRangeUser(0-0.5, 20-0.5);
