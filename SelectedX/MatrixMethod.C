...
/// -------------------------------- Electron Channel ------------------------------------ ///
void MatrixMethod (Bool_t DEBUG=kFALSE)
{
    TTimeStamp ts_start;
...
//            if (fabs(etaSC->at(1)) > 1.566 && (Full5x5_SigmaIEtaIEta->at(1) >= 0.035 || HoverE->at(1) >= 0.13)) continue;
            ...
            {
                MatrixMethod_weights = analyzer->MatrixMethod_evtWeight(p_T->at(0), etaSC->at(0), passMediumID->at(0), p_T->at(1), etaSC->at(1), passMediumID->at(1));
            ...
            {
                MatrixMethod_weights = analyzer->MatrixMethod_evtWeight(p_T->at(1), etaSC->at(1), passMediumID->at(1), p_T->at(0), etaSC->at(0), passMediumID->at(0));
