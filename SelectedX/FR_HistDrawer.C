...
//--------------------------------- Ratio Plots --------------------------------------
    ...
    RP_SigmaIEtaIEta_endcap_nume->SetPlots("#sigma_{i#etai#eta} (e_{#lower[-0.4]{endcap}}^{nume})", 0, 0.01);
    ...
    RP_dEtaInSeed_barrel_deno->SetPlots("dEtaInSeed (e_{#lower[-0.4]{barrel}}^{deno})", -1, 1);
    RP_dEtaInSeed_endcap_deno->SetPlots("dEtaInSeed (e_{#lower[-0.4]{endcap}}^{deno})", -1, 1);
    RP_dEtaInSeed_barrel_ctrl->SetPlots("dEtaInSeed (e_{#lower[-0.4]{barrel}}^{control})", -1, 1);
    ...
    RP_HoverE_barrel_nume->SetPlots("H/E (e_{#lower[-0.4]{barrel}}^{nume})", 0, 0.5);
    RP_HoverE_endcap_nume->SetPlots("H/E (e_{#lower[-0.4]{endcap}}^{nume})", 0, 0.5);
    RP_HoverE_barrel_deno->SetPlots("H/E (e_{#lower[-0.4]{barrel}}^{deno})", 0, 10);
    RP_HoverE_endcap_deno->SetPlots("H/E (e_{#lower[-0.4]{endcap}}^{deno})", 0, 10);
    RP_HoverE_barrel_ctrl->SetPlots("H/E (e_{#lower[-0.4]{barrel}}^{control})", 0, 10);
    RP_HoverE_endcap_ctrl->SetPlots("H/E (e_{#lower[-0.4]{endcap}}^{control})", 0, 10);
