...
//--------------------------------- FR by template --------------------------------------
    ...
    h_pT_barrel_template_deno->Scale(2.0857e+07/h_pT_barrel_template_deno->Integral()); // To compare with Dalmin
...
//    h_pT_barrel_template_deno->Scale(1.8118e+07/h_pT_barrel_template_deno->Integral());
    ...
    h_pT_endcap_template_deno->Scale(1.0111e+07/h_pT_endcap_template_deno->Integral()); // To compare with Dalmin
