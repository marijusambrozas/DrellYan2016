...
\begin{table}[t!]
	\begin{tabular}{|c|c|c|}
		\hline
		\multirow{2}{9em}{\centering\textbf{Kriterijaus tipas}} &
			\multirow{2}{12em}{\centering\textbf{\textit{µµ} atrankos reikalavimas}} &
			\multirow{2}{13em}{\centering\textbf{\textit{ee} atrankos reikalavimas}} \\
		 & & \\
		\hline\hline
		\multirow{4}{9em}{\centering Aukšto lygio trigeris} &
			\multirow{2}{13em}{\centering\ttt{HLT\_IsoMu24} arba \ttt{HLT\_IsoTkMu24}} &
			\multirow{4}{12em}{\centering\ttt{HLT\_Ele23Ele12}} \\
		 & & \\ \cline{2-2}
		...
		\multirow{4}{9em}{\centering Kinematiniai reikalavimai} &
		 ...
		 & & \\ \cline{2-3}
		 & \multirow{2}{12em}{\centering $|\eta| < 2.4$} & $|\eta_{\mathrm{SC}}| < 2.4$, \\
		 & & išskyrus $1.4442<|\eta_{\mathrm{SC}}|<1.566$ \\
		\hline\hline
		\multirow{2}{9em}{\centering Dalelės atpažinimo reikalavimai} &
			\ltq{\ttt{TightID}} reikalavimai &
			\multirow{2}{13em}{\centering \ltq{\ttt{MediumID}} reikalavimai} \\ \cline{2-2}
...
\begin{table}[!b]
	\begin{tabular}{|c|c|c|c|}
		...
		\hline\hline
		\multicolumn{2}{|c|}{\multirow{2}{16em}{\centering \ttt{SingleMuon} duomenų rinkinyje esantys aukšto lygio trigeriai}} &
...
\begin{table}[H]
	\begin{tabular}{|c|c|}
		\hline
		\multirow{4}{13em}{\centering Invariantinė masė $m_{\mu\mu}$, $m_{ee}$, $m_{\emu}$ [GeV]} &
			\multirow{4}{25em}{15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 64, 68, 72, 76, 81, 86, 91, 96, 101,
				106, 110, 115, 120, 126, 133, 141, 150, 160, 171, 185, 200, 220, 243, 273, 320, 380, 440, 510, 600, 700,
				830, 1000, 1500, 3000.} \\
		 & \\
		 & \\
		 & \\
		\hline
		\multirow{4}{13em}{\centering Skersinis impulsas miuono objektams $\pT(\mu)$ [GeV]} &
			\multirow{4}{25em}{CMS cilindre ($|\eta|<1.2$): 52, 60, 70, 80, 90, 100, 120, 140, 160, 180, 200, 250, 300,
				350, 400, 450, 500, 700, 1000; \\
				CMS antgaliuose ($|\eta|\geqslant1.2$): 52, 60, 70, 80, 90, 100, 150, 200, 500, 1000.} \\
		 & \\
		 & \\
		 & \\
		\hline
		\multirow{2}{13em}{\centering Skersinis impulsas elektrono objektams $\pT(e)$ [GeV]} &
			\multirow{2}{25em}{25, 30, 35, 40, 45, 50, 55, 60, 70, 80, 90, 100, 120, 140, 160, 175, 200, 250, 300, 400, 500, 800, 5000.} \\
		 & \\
		\hline
		\multirow{2}{13em}{\centering Pirminių viršūnių skaičius $N_{\mathrm{VTX}}$} &
			\multirow{2}{25em}{50 vienetinio pločio stulpelių nuo 0 iki 50.} \\
		 & \\
		\hline
		\multirow{2}{13em}{\centering Sparta $y_{ee}$, $y_{\mu\mu}$} &
			\multirow{2}{25em}{100 vienodo pločio stulpelių nuo -5 iki 5 (plotis $=0.1$).} \\
		 & \\
		\hline
		\multirow{5}{13em}{\centering Miuono objekto santykinio izoliuotumo parametras $I_{\mathrm{PF}}^{\mathrm{rel.}}$} &
			\multirow{5}{25em}{Signalo srityje: 30 vienodo pločio stulpelių nuo 0 iki 0.15 (plotis $=0.005$); \\
				Kontrolinėje srityje: 50 vienodo pločio stulpelių nuo 0.15 iki 5 (plotis $=0.097$). \\
				Signalo ir kontrolinė sritys apibrėžtos \ref{sec:FRmeasure} skyriuje.} \\
		 & \\
		 & \\
		 & \\
		 & \\
		\hline
	\end{tabular}
	\caption{\label{table:bins} Darbe vaizduotų histogramų stulpelių sudalijimai.}
\end{table}
