...
\begin{table}[t]
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
		\multicolumn{2}{|c|}{\multirow{5}{15em}{\centering \ltq{\ttt{TightID}} reikalavimai}} &
			\multicolumn{2}{c|}{\multirow{3}{20em}{\centering Pataikymams į EM kalorimetro cilindrą:\\ $\sigma_{i\eta i\eta}<0.013$,
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\multicolumn{2}{|c|}{\ttt{TightID} reikalavimai} &
			\multicolumn{2}{c|}{\multirow{3}{19em}{\centering Pataikymams į EM kalorimetro cilindrą:\\ $\sigma_{i\eta i\eta}<0.013$,
				$H/E<0.13$,\\ $|\Delta\eta_{in}^{seed}|<0.01$, $|\Delta\phi_{in}|<0.07$}} \\ \cline{1-2}
		\multicolumn{2}{|c|}{\multirow{3}{16em}{\centering Pasirenkami 2 miuonai, kuriuos galima tiksliausiai suvesti į vieną
			pirminę viršūnę su $\chi^2<20$}} & \multicolumn{2}{c|}{ } \\
		\multicolumn{2}{|c|}{ } & \multicolumn{2}{c|}{ } \\ \cline{3-4}
		\multicolumn{2}{|c|}{ } & \multicolumn{2}{c|}{\multirow{2}{19em}{\centering Pataikymams į EM kalorimetro antgalius:\\
			$\sigma_{i\eta i\eta}<0.035$, $H/E<0.13$}} \\ \cline{1-2}
		\multicolumn{2}{|c|}{Priešingi elektriniai krūviai} & \multicolumn{2}{c|}{} \\
		\hline
