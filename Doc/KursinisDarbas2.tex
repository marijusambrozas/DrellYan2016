...
\begin{table}
	\begin{tabular}{|c|c|}
		...
		\hline\hline
		\multirow{4}{17em}{\centering Trigeris: \ttt{HLT\_Ele23\_Ele12...}}
		...
		\multirow{5}{17em}{\centering Atranką turi praeiti lygiai 2 elektronai} &
		 ...
		 & 3D kampas $< \pi - 0.005$ rad \\
		\hline
	\end{tabular}
	\caption{\label{table:selection}Apibendrinti atrankos kriterijai, taikyti $ee$ ir $\mu\mu$ įvykiams. $p_{\mathrm{T \, 1}}$ ir
	$p_{\mathrm{T \, 2}}$ žymi 	greitesniojo ir lėtesniojo leptono skersinį impulsą.
...
\begin{table}
	\begin{tabular}{|c|c|}
		...
		\hline
		\multicolumn{2}{|c|}{\centering $p_{\mathrm{T \, 1}} > 28$ GeV, $p_{\mathrm{T \, 2}} > 17$ GeV} \\
		\hline
		...
		\multicolumn{2}{|c|}{} \\
		\hline
		\multicolumn{2}{|c|}{\centering 3D kampas $< \pi - 0.005$ rad} \\
		\hline
	...
	\hline
	\end{tabular}
	\caption{\label{table:selection}Apibendrinti atrankos kriterijai, taikyti elektronui ir miuonui $\emu$ įvykių atrankoje.
	$p_{\mathrm{T \, 1}}$ ir $p_{\mathrm{T \, 2}}$ žymi greitesniojo ir lėtesniojo leptono skersinį impulsą,
